    ...
    def run(self):
        ...
        try:
            ...
            if len(dataset_files) != rounds:
                raise Exception(
                    f"sum({len(dataset_files)}) of dataset files not equal rounds({rounds}) of incrementallearning job.")
        ...
        for r in range(1, rounds + 1):
            ...
            train_dataset = self._process_dataset(train_dataset_file, dataset.label, "train", feature_process)
